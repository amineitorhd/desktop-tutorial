...
class Fenetre_princiaple:
    def __init__(self,filtres_data):
        ...
        image_fond = image_fond.resize((1000, 1800))
        ...
        self.treeview_resultat.grid(column=3, row=0, padx=10, pady=10, rowspan=2)
    ...
    def affiche_resultat(self, data):
        ...
        for col in colonnes:
            ...
            self.treeview_resultat.column(col, anchor=tk.CENTER, width=80)  # Ajustez la largeur selon vos besoins
